          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 lg:gap-6">
            <div className="space-y-2">
              <div className="flex items-center gap-3 lg:gap-4">
                <div className="w-12 h-12 lg:w-16 lg:h-16 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl lg:rounded-3xl flex items-center justify-center shadow-lg">
            ...
            <button className="bg-gradient-to-r from-emerald-600 to-green-600 text-white px-6 py-3 lg:px-8 lg:py-4 rounded-2xl font-semibold transition-all duration-200 hover:scale-105 hover:shadow-xl shadow-lg shadow-emerald-200 flex items-center gap-3 w-full lg:w-auto justify-center">
                    ...
                    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-4 sm:p-6 rounded-2xl border border-blue-200">
                      <div className="flex items-center justify-between gap-3 sm:gap-4">
                        <div className="flex items-center gap-3 sm:gap-4 min-w-0 flex-1">
                          ...
                          >
                            {darkMode ? (
                              ...
                              <Sun className="w-5 h-5 sm:w-7 sm:h-7 text-white" />
                            )}
                          </div>
                        ...
                        <button
                          ...
                          className={`relative w-12 h-6 sm:w-16 sm:h-8 rounded-full transition-all duration-300 shadow-inner flex-shrink-0 ${
                            darkMode
                        ...
                        >
                          <div
                            className={`absolute top-0.5 left-0.5 sm:top-1 sm:left-1 w-5 h-5 sm:w-6 sm:h-6 bg-white rounded-full shadow-lg transition-transform duration-300 ${
                              darkMode
                    ...
                    <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-2xl border border-purple-200">
                      ...
                      <div className="grid gap-4">
                        {(
                          ...
                          <div
                            key={method.key}
                            className="group bg-white/80 backdrop-blur-sm p-4 rounded-xl border border-white/50 hover:shadow-lg transition-all"
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-4">
                                <div
                                  className={`w-12 h-12 bg-gradient-to-br ${method.color} rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform`}
                                >
                        ...
                        {(
                          ...
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-4">
                                <div
                                  className={`w-12 h-12 bg-gradient-to-br ${type.color} rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform`}
                                >
                      ...
                      <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                          ...
                          <p className="text-yellow-800">
                            Please update your tax information to continue
                            receiving payments
                          </p>
                        </div>
                      </div>
