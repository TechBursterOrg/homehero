...
const Profile: React.FC = () => {
  ...
  const badges = [
    ...
    { name: 'Verified Pro', icon: BadgeCheck, color: 'from-green-400 to-blue-600', bgColor: 'from-green-50 to-green-50' },
  ...
  const achievementStats = [
    { label: 'Completed Jobs', value: profileData.completedJobs, icon: CheckCircle, color: 'from-green-500 to-green-600' },
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-green-50 to-indigo-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <button
            ...
            className="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-green-700"
          >
            Retry
          </button>
        </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-green-50 to-indigo-100">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex flex-col space-y-4 sm:space-y-6">
            <div className="flex items-center gap-3 sm:gap-4">
              <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 bg-gradient-to-br from-green-500 to-green-600 rounded-xl sm:rounded-2xl lg:rounded-3xl flex items-center justify-center shadow-lg flex-shrink-0">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 overflow-hidden mb-6 sm:mb-8">
          <div className="h-24 sm:h-32 lg:h-40 bg-gradient-to-r from-green-500 via-green-500 to-green-500 relative">
          ...
          <div className="p-4 sm:p-6 lg:p-8 -mt-12 sm:-mt-16 lg:-mt-20">
            <div className="flex flex-col sm:flex-row items-start sm:items-end gap-4 sm:gap-6">
              <div className="relative mx-auto sm:mx-0">
                <div className="w-20 h-20 sm:w-24 sm:h-24 lg:w-32 lg:h-32 bg-gradient-to-br from-green-500 to-green-600 rounded-2xl sm:rounded-3xl flex items-center justify-center border-2 sm:border-4 border-white shadow-xl overflow-hidden">
            ...
            <nav className="flex px-3 sm:px-6 lg:px-8 overflow-x-auto">
              {tabs.map((tab) => (
                ...
                >
                  ...
                  <span>{tab.name}</span>
                  {tab.id === 'reviews' && (
                    <span className="bg-green-100 text-green-600 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full text-xs font-bold">
            ...
            {activeTab === 'overview' && (
              <div className="space-y-6 sm:space-y-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
                  {/* Contact Information */}
                  <div className="bg-gradient-to-br from-green-50 to-green-50 p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-green-200">
                      ...
                      {isEditing ? (
                        <div className="p-2 sm:p-3 bg-white/60 backdrop-blur-sm rounded-lg sm:rounded-xl">
                          <input
                            ...
                            className="w-full bg-transparent text-gray-700 font-medium text-sm sm:text-base border border-green-300 rounded-lg px-3 py-2"
                        ...
                        >
                          ...
                          <div className="absolute top-2 left-2">
                            <span className={`px-2 py-1 rounded-lg text-xs font-medium text-white shadow-lg ${
                              image.category === 'cleaning' ? 'bg-green-500' :
                    ...
                    {ratings.map((rating) => (
                      <div key={rating._id} className="group bg-gradient-to-br from-white to-yellow-50 p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-gray-200 hover:shadow-lg hover:border-yellow-300 transition-all duration-300">
                        <div className="flex gap-3 sm:gap-4">
                          <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-green-500 to-purple-600 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg flex-shrink-0">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex flex-col sm:flex-row sm:items-start justify-between mb-2 sm:mb-3 gap-2">
                              <div className="min-w-0">
                                ...
                                <p className="text-xs sm:text-sm text-green-600 font-medium">{rating.serviceType}</p>
                              </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mb-3">
                        <span className={`px-3 py-1 rounded-lg text-sm font-medium text-white ${
                          selectedImage.category === 'cleaning' ? 'bg-green-500' :
