...
const ProviderProfilePage: React.FC = () => {
  ...
  const [bookingServiceType, setBookingServiceType] = useState<'immediate' | 'long-term'>('immediate');
  ...
  const handleBookNow = () => {
    if (provider) {
      setBookingServiceType(provider.isAvailableNow ? 'immediate' : 'long-term');
