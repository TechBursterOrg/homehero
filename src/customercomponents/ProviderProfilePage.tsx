...
const ProviderProfilePage: React.FC = () => {
  ...
  const fetchGalleryImages = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/providers/${providerId}/gallery`);
      ...
      if (response.ok) {
        ...
        if (data.success) {
          ...
          // Use sample data if no gallery data available
  ...
  const fetchReviews = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/providers/${providerId}/reviews`);
      ...
      if (response.ok) {
        ...
        if (data.success) {
          ...
          // Use sample data if no reviews available
  ...
  // Fixed return type to match img src requirement
  const getFullImageUrl = (url: string | undefined): string | undefined => {
    ...
    // Otherwise, it might be a filename, construct the full URL
  ...
  const getSampleReviews = (): Review[] => [
    {
      ...
      rating: 5,
      comment: 'Excellent work! The kitchen renovation exceeded my expectations. Professional and timely completion.',
      date: '2024-01-20',
    ...
    },
    {
      ...
      rating: 4,
      comment: 'Good quality painting work. Clean and efficient service. Would recommend for home projects.',
      date: '2024-01-18',
    ...
    },
    {
      ...
      rating: 5,
      comment: 'Outstanding plumbing service! Fixed the issue quickly and explained everything clearly.',
      date: '2024-01-15',
    ...
    },
    {
      ...
      rating: 4,
      comment: 'Professional and reliable. The garden looks amazing after the maintenance work.',
      date: '2024-01-12',
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-2">Provider Not Found</h3>
          <p className="text-gray-600 mb-4">{error || 'The provider profile could not be loaded.'}</p>
          <button
            onClick={() => navigate(-1)}
      ...
      <div className="bg-white/80 backdrop-blur-sm border-b border-gray-200 sticky top-0 z-40">
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl sm:text-2xl font-bold text-gray-900 truncate">Provider Profile</h1>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-4 sm:py-8">
          ...
          <div className="flex flex-col gap-6">
              ...
              <div className="flex-1 text-center sm:text-left">
                ...
                <div className="space-y-2 text-sm sm:text-base text-gray-600">
                  <div className="flex items-center justify-center sm:justify-start gap-2">
                    ...
                    <span className="truncate">{provider.city}, {provider.state}, {provider.country}</span>
                  </div>
                  <div className="flex items-center justify-center sm:justify-start gap-2">
                    <Clock className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" />
                    <span>Response time: {provider.responseTime || 'Within 1 hour'}</span>
                  </div>
                  <div className="flex items-center justify-center sm:justify-start gap-2">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                ...
                className="bg-white border border-gray-300 text-gray-700 px-6 py-3 rounded-xl font-semibold hover:bg-gray-50 transition-colors flex items-center justify-center gap-2 flex-1 sm:flex-none"
              >
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 mb-4 sm:mb-8">
          ...
          <div className="p-4 sm:p-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 sm:p-6">
                    <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-4">Services Offered</h3>
                  ...
                  <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 sm:p-6">
                    <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-4">Professional Details</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-700 mb-2">Hourly Rate</h4>
                        <p className="text-xl sm:text-2xl font-bold text-green-600">₦{provider.hourlyRate}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  {/* Stats */}
                  <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 sm:p-6">
                    <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-4">Performance Stats</h3>
                  ...
                  <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 sm:p-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start gap-3">
                        ...
                        <span className="text-gray-700 text-sm break-all">{provider.email}</span>
                      </div>
                      {provider.phoneNumber && (
                        <div className="flex items-center gap-3">
                          <Phone className="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 flex-shrink-0" />
                          <span className="text-gray-700 text-sm">{provider.phoneNumber}</span>
                        </div>
                      )}
                      {provider.address && (
                        <div className="flex items-start gap-3">
            ...
            {activeTab === 'services' && (
              <div className="space-y-6">
                <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-4">All Services</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                  {provider.services.map((service, index) => (
                    <div key={index} className="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 sm:p-6">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <h4 className="font-bold text-gray-900 text-base sm:text-lg">{service}</h4>
                      </div>
                      <p className="text-gray-600 mb-4 text-sm">
                        Professional {service.toLowerCase()} services with years of experience and quality guarantee.
                      </p>
                      <div className="flex items-center justify-between">
                        <span className="text-xl sm:text-2xl font-bold text-green-600">₦{provider.hourlyRate}</span>
            ...
            {activeTab === 'gallery' && (
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-gray-600 text-sm">{galleryImages.length} projects</span>
                </div>
                
                {galleryLoading ? (
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
                    {[...Array(8)].map((_, i) => (
                      <div key={i} className="aspect-square bg-gray-200 rounded-xl sm:rounded-2xl animate-pulse"></div>
                    ))}
                  </div>
                ) : (
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
                    {galleryImages.map((image) => (
                      <div
                        key={image.id}
                        className="group relative bg-white rounded-xl sm:rounded-2xl shadow-sm border border-gray-200 overflow-hidden cursor-pointer hover:shadow-lg transition-all duration-300"
              ...
              <div className="space-y-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Based on {reviews.length} verified reviews</p>
                  </div>
                  <div className="flex items-center gap-3 bg-blue-50 px-4 py-2 rounded-xl w-fit">
                    <div className="flex items-center gap-1">
                      {renderReviewStars(provider.averageRating, 'w-4 h-4 sm:w-5 sm:h-5')}
                    </div>
                    <span className="font-bold text-gray-900 text-sm sm:text-base">{provider.averageRating.toFixed(1)}</span>
                  </div>
                </div>
                ...
                {reviewsLoading ? (
                  <div className="space-y-4">
                    {[...Array(3)].map((_, i) => (
                      <div key={i} className="bg-white rounded-xl sm:rounded-2xl shadow-sm border border-gray-200 p-4 sm:p-6 animate-pulse">
                  ...
                  <div className="space-y-4">
                    {reviews.map((review) => (
                      <div key={review.id} className="bg-white rounded-xl sm:rounded-2xl shadow-sm border border-gray-200 p-4 sm:p-6">
                        <div className="flex items-start gap-3 sm:gap-4 mb-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 sm:gap-2 mb-2">
                              <h4 className="font-bold text-gray-900 text-sm sm:text-base truncate">{review.customerName}</h4>
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-2">
                              ...
                              <span className="text-xs sm:text-sm text-blue-600 font-medium">{review.service}</span>
                            </div>
                          </div>
                        </div>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
            <div className="flex items-center justify-between p-4 sm:p-6 border-b border-gray-200">
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 truncate pr-4">{selectedImage.title}</h3>
              <button
            ...
            <div className="p-4 sm:p-6 max-h-[calc(90vh-80px)] overflow-y-auto">
              <div className="grid lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">Project Details</h4>
                    <p className="text-gray-700 leading-relaxed text-sm sm:text-base">
                      {selectedImage.description || 'No description available for this project.'}
                    </p>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-blue-50 p-3 sm:p-4 rounded-xl">
                      <p className="text-xs sm:text-sm text-gray-600">Category</p>
                      <p className="font-semibold text-gray-900 capitalize text-sm sm:text-base">{selectedImage.category}</p>
                    </div>
                    <div className="bg-green-50 p-3 sm:p-4 rounded-xl">
                      <p className="text-xs sm:text-sm text-gray-600">Upload Date</p>
